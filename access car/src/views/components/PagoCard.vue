<!-- Template para Vista de los pagos -->
<template>
  <div class="card">
        <div class="card-header pb-0 p-3">
      <div class="row">
        <div class="col-6 d-flex align-items-center">
          <h6 class="mb-0">Información Pagos</h6>
        </div>
        <div class="col-6 text-end">
<a class="btn bg-gradient-success mb-0" @click="addPago()">
  <i class="fas fa-plus" aria-hidden="true"></i> Nuevo Pago</a>
</div>
      </div>
    </div>
